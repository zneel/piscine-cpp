...
Form::Form(std::string name, int gradeRequiredToSign, int gradeRequiredToExec)
    : name_(name), signed_(false), gradeRequiredToSign_(gradeRequiredToSign), gradeRequiredToExec_(gradeRequiredToExec)
{
...
Form::Form(const Form &other)
    : name_(other.name_), signed_(false), gradeRequiredToSign_(other.gradeRequiredToSign_),
...
std::ostream &operator<<(std::ostream &o, Form const &f)
{
    o << "Form informations:" << std::endl
      ...
      << "grade required to sign: " << f.getGradeRequiredToSign() << std::endl
